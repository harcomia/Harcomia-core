Contributing to HCA Core
============================

The HCA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HCA Core project, and is not to be
confused with overall HCA Network Protocol consensus changes.

Whether a pull request is merged into HCA Core rests with the project merge
...
Patches that change HCA consensus rules are considerably more involved than
...
Where a patch set proposes to change the HCA consensus, it must have been
...
The project leader is the release manager for each HCA Core release.
