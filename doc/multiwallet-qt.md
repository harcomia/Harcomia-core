...
In order to support loading of multiple wallets in hca-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hca.cpp.
...
Changes to hca.cpp
----------------------
hca.cpp is the entry point into hca-qt, and as such, will require some minor modifications to provide hooks for
