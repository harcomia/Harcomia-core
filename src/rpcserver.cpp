...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HCA features */
        {"hca", "masternode", &masternode, true, true, false},
        {"hca", "listmasternodes", &listmasternodes, true, true, false},
        {"hca", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hca", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hca", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hca", "masternodedebug", &masternodedebug, true, true, false},
        {"hca", "startmasternode", &startmasternode, true, true, false},
        {"hca", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hca", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hca", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hca", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hca", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hca", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hca", "mnbudget", &mnbudget, true, true, false},
        {"hca", "preparebudget", &preparebudget, true, true, false},
        {"hca", "submitbudget", &submitbudget, true, true, false},
        {"hca", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hca", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hca", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hca", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hca", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hca", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hca", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hca", "checkbudgets", &checkbudgets, true, true, false},
        {"hca", "mnsync", &mnsync, true, true, false},
        {"hca", "spork", &spork, true, true, false},
        {"hca", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hca", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hcad, or the -server option to hca-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hca-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16381/\n";
}
