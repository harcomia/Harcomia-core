...
// Copyright (c) 2015-2018 The HCA developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HCA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HCA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and HCA: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHCA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HCA Core"), this);
    aboutAction->setStatusTip(tr("Show information about HCA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HCA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HCA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HCA addresses"));
    ...
    openAction->setStatusTip(tr("Open a HCA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HCA Core help message to get a list with possible HCA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HCA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HCA network", "", count));
}
...
{
    QString strTitle = tr("HCA Core"); // default title
