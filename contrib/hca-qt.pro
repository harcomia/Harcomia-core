...
RESOURCES += src/qt/hca.qrc src/qt/hca_locale.qrc

TRANSLATIONS += src/qt/locale/hca_bg.ts \
                src/qt/locale/hca_de.ts \
                src/qt/locale/hca_en.ts \
                src/qt/locale/hca_es.ts \
                src/qt/locale/hca_fi.ts \
                src/qt/locale/hca_fr.ts \
                src/qt/locale/hca_it.ts \
                src/qt/locale/hca_ja.ts \
                src/qt/locale/hca_pl.ts \
                src/qt/locale/hca_pt.ts \
                src/qt/locale/hca_ru.ts \
                src/qt/locale/hca_sk.ts \
                src/qt/locale/hca_sv.ts \
                src/qt/locale/hca_vi.ts \
                src/qt/locale/hca_zh_CN.ts \
                src/qt/locale/hca_zh_TW.ts
